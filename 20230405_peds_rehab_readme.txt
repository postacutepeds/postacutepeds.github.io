A National Survey of Pediatric Post-Acute Care: 
An Open-Access Database of Pediatric Facilities 

We identified and surveyed facilities that provide post-acute care to pediatric patients across the United States and created a database of these findings. For specific methods, see our manuscript.

Please contact us at postacute.peds@gmail.com. 
...
Values:
1= Facility accepts pediatric patients 
...
Values:
5 or 6-character alphanumeric code 
‘MISS’ prefix indicates facilities that could not be matched in CMS database
 
Variable name: ZIP
Description: Five-digit ZIP code for a facility physical address
Values: 5 digit code 
 
Variable name: FREE
...
Description: Latitude for a facility physical address
Values: Numerical geocode 
 
Variable name: longitude
Description: longitude for a facility physical address
Values: Numerical geocode